...
class LoginPage {
	...
	public function __construct() {
		...
		add_action( 'login_enqueue_scripts', array( $this, 'themeslug_enqueue_style'), 10 );
		...
		add_action('login_footer', array( $this, 'footer_text') );
		add_action('init', array( $this, 'change_login_title') );
	...
	public function hide_login_nav()
	{
		...
		<style>
			...
			*/
			...
			.login h1 a {
				transition: all 1s;
				background-image:url(<?php echo get_template_directory_uri(); ?>/asset/admin/login.png);
				background-size:100%;
	...
	public function themeslug_enqueue_style() {
		wp_enqueue_style( 'awesome-font', get_template_directory_uri().'/asset/admin/font-awesome-4.7.0/css/font-awesome.min.css', false );
	}

	//change logo Url
	public function custom_login_header_url($url) { return home_url(); }

	//change title logo
	public function my_login_logo_url_title() { return ' ';}
