...
class Widget {
	...
	public function __construct() {
		//add Widget init
		add_action( 'widgets_init', array( $this, 'WPTemplate_widgets_init') );
		//Add input fields(priority 5, 3 parameters)
		//add_action('in_widget_form', array( $this, 'kk_in_widget_form'),5,3);
		//Callback function for options update (priorität 5, 3 parameters)
		//add_filter('widget_update_callback', array( $this, 'kk_in_widget_form_update'),5,3);
		//add class names (default priority, one parameter)
		//add_filter('dynamic_sidebar_params', array( $this, 'kk_dynamic_sidebar_params'));
	}

	// Declare sidebar widget zone
	public function WPTemplate_widgets_init() {
	...
	public function kk_in_widget_form($t,$return,$instance){
	...
	public function kk_in_widget_form_update($instance, $new_instance, $old_instance){
	...
	public function kk_dynamic_sidebar_params($params){
